...
function layout (col1, col2, col3) {
  ...
  return html`<div class="container pb1 x vh100">
    <div sm="db" md="c3" class="c4 pr1-5 oa ${scroll} br1-lightgray dn">
      ${col1}
    </div>
    <div sm="c8 px1-5" md="${three ? 'c5' : 'c9'}" class="c12 container oa  ${scroll} undo-container undo-bottom hide-scroll">
      ${col2}
    </div>
    ${container3}
  </div>`
